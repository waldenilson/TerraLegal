...
from project.tramitacao.forms import FormSituacaoProcesso, FormSituacaoGeo
from django.contrib import messages
from django.http.response import HttpResponseRedirect, HttpResponse
from project.tramitacao.models import Tbsituacaoprocesso, Tbsituacaogeo, AuthUser
