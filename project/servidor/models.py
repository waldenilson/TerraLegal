...
class Tbservidor(models.Model):
    ...
    tbdivisao = models.ForeignKey('tramitacao.Tbdivisao')
...
class Tbferias(models.Model):
    ...
    stSituacao1 = models.ForeignKey('tramitacao.Tbsituacao',related_name='situacao_p1')
    dtInicio2 = models.DateTimeField(null=True,blank=True)
    nrDias2 = models.IntegerField(null=True,blank=True)
    stSituacao2 = models.ForeignKey('tramitacao.Tbsituacao',related_name='situacao_p2')
    dtInicio3 = models.DateField(null=True,blank=True)
    nrDias3 = models.IntegerField(null=True,blank=True)
    stSituacao3 = models.ForeignKey('tramitacao.Tbsituacao',related_name='situacao_p3')
