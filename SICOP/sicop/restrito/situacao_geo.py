...
response_consulta  = "/sicop/restrito/situacao_geo/consulta/"
...
@permission_required('sicop.situacao_geo_edicao', login_url='/excecoes/permissao_negada/', raise_exception=True)
