...
from project.tramitacao.forms import FormSituacaoProcesso
from django.contrib import messages
from django.http.response import HttpResponseRedirect, HttpResponse
from project.tramitacao.models import Tbsituacaoprocesso, AuthUser
...
response_consulta  = "/tramitacao/situacao_processo/consulta/"
...
def cadastro(request):
    if request.method == "POST":
        ...
        if validacao(request):
            ...
            f_situacaogeo.save()
            if next == "/":
                return HttpResponseRedirect("/tramitacao/situacao_processo/consulta/")
            else:    
...
def edicao(request, id):
    ...
    if request.method == "POST":
        ...
        if not request.user.has_perm('sicop.situacao_processo_edicao'):
        ...
        if validacao(request):
           ...
           f_situacaogeo.save()
           return HttpResponseRedirect("/tramitacao/situacao_processo/edicao/"+str(id)+"/")
