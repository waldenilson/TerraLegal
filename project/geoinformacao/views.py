...
from project.tramitacao.models import Tbmunicipio
from project.core.funcoes import reader_csv

from project.geoinformacao.models import TbparcelaGeo, Indigena
