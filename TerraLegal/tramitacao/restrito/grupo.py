...
from TerraLegal.tramitacao.forms import FormStatusPendencia, FormAuthGroup
from TerraLegal.tramitacao.models import Tbstatuspendencia, AuthGroup, AuthPermission,\
