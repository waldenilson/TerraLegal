...
from project.tramitacao.models import  AuthUser, Tbdivisao, Tbsituacao
from project.servidor.models import Tbferias, Tbservidor
from project.documento.models import Tbdocumentoservidor
