...
from project.tramitacao.models import AuthUser, Tbgleba, Tbsubarea, Tbpendencia, Tbtipopendencia,\
    Tbstatuspendencia
...
def edicao(request, pendencia):
    ...
    if request.method == "POST":
        if validacao(request):
            ...
            f_pendencia.save()
            return HttpResponseRedirect("/tramitacao/processo/edicao/"+str(instance.tbprocessobase.id)+"/")
